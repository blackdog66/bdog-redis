...
typedef RedisClient = {
  ...
  function lindex(l:String,i:Int,cb:MultiReply):Void;
  ...
  function hmset(k:Array<String>,cb:StatusReply):Void;
...
class Redis {
 ...
 newClient(libpath=""):RedisClient {
   var c = Node.require(libpath+'redis-client');
